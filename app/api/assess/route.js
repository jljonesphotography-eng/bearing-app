...
Before generating the JSON, analyze the user's text responses across the full conversation and set capability_score to an integer from 0 to 100. Score higher when answers are specific, concrete, detailed, and process-rich (including messy or informal detail that reveals real judgment and tradeoffs). Score lower for vague, polished, generic, resume-like, or performative answers that lack observable evidence of how they actually think and work. This score reflects the quality and observability of evidence in what they wrote, not charisma or agreeability.
